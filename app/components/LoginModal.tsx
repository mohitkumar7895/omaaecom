        ...
        <div className="flex flex-col items-center mt-2">
          ...
          <div className="w-full">
            ...
            <button 
              ...
              disabled={loading}
              className="w-full bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-800 font-bold py-3.5 sm:py-4 rounded-[16px] transition-all active:scale-[0.98] shadow-sm text-[16px] tracking-wide flex justify-center items-center gap-3 h-[56px] disabled:opacity-70 disabled:active:scale-100 relative overflow-hidden"
            >
              {loading ? (
