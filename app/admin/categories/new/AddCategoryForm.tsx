        ...
        <form action={handleSubmit} className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
            ...
            <div className="space-y-2 md:col-span-2 mt-2">
              <label className="text-[13px] font-bold text-gray-800">Add Zones (Multiple Locations)</label>
              <input 
                type="text" 
                name="zones_location"
                placeholder="Type area name (Example: Noida)"
                className="w-full border border-gray-200 rounded text-sm px-4 py-2.5 outline-none focus:border-blue-500"
              />
              <input type="hidden" name="zones" value={1} />
            </div>
            ...
            <div className="w-full h-[450px] border border-gray-200 rounded overflow-hidden mt-2 md:col-span-2">
              <iframe 
