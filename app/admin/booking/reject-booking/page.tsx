...
export const metadata = {
  title: "Reject Booking - OMAA Admin",
};
    ...
    <div className="flex-1 bg-white min-h-screen">
      <div className="p-8">
        ...
        <div className="flex justify-between items-end mb-4">
          <ExportButtons tableId="reject-booking-table" />
        ...
        <div className="border border-gray-200 overflow-x-auto">
          <table id="reject-booking-table" className="w-full text-left border-collapse min-w-[1600px]">
            <thead>
