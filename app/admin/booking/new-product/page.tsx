...
export const metadata = {
  title: "New Product Booking - OMAA Admin",
};
    ...
    <div className="flex-1 bg-white min-h-screen">
      <div className="p-8">
        ...
        <div className="flex items-center space-x-2 mb-6">
          ...
          <Link href="/admin/booking?filter=AMC">
            <button className="px-4 py-1.5 rounded font-medium transition text-[#2962ff] hover:bg-blue-50 text-[13px]">
              AMC
            </button>
          </Link>
        ...
        <div className="flex justify-between items-end mb-4">
          <ExportButtons tableId="new-product-table" />
        ...
        <div className="border border-gray-200 overflow-x-auto">
          <table id="new-product-table" className="w-full text-left border-collapse min-w-[1600px]">
            <thead>
