        ...
        <div className="bg-white rounded-[24px] shadow-xl p-6 sm:p-8 max-w-[420px] w-full border border-gray-100">
          ...
          {user ? (
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500 mb-6">Authenticated as: <br/><span className="font-semibold text-gray-800">{user.email || user.displayName}</span></p>
            ...
            <>
              ...
              <button 
                ...
                disabled={loading}
                className="w-full bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-800 font-bold py-3.5 sm:py-4 rounded-[16px] transition-all active:scale-[0.98] shadow-sm text-[16px] tracking-wide flex justify-center items-center gap-3 h-[56px] disabled:opacity-70 disabled:active:scale-100"
              >
                {loading ? (
