                ...
                <div className="border-b border-gray-50 p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-gray-50/50">
                  <div className="flex items-center gap-3">
                    <span className={`px-2.5 py-1 rounded-md text-[11px] font-black uppercase tracking-wider ${
                      booking.working_status === 'Completed' ? 'bg-emerald-100 text-emerald-700' :
                    ...
                    {booking.ad_watched && booking.cashback_amount > 0 && (
                      <div className="mt-4 pt-4 border-t border-gray-200">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`text-[13px] font-black ${booking.working_status === 'Completed' ? 'text-emerald-600' : 'text-amber-500'}`}>
                            {booking.working_status === 'Completed' ? '+₹' + booking.cashback_amount : 'Pending ₹' + booking.cashback_amount}
                          </span>
                        </div>
                      </div>
                    )}
